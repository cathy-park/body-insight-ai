              ...
              <section className={sectionClass}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input id="modal-sleep_hours" type="number" step="0.5" name="sleep_hours" value={formData.sleep_hours || ''} onChange={handleChange} className={inputClass} placeholder="7.0" inputMode="decimal" />
                  </div>
                  <div>
                    <label htmlFor="modal-bowel_condition" className={labelClass}>배변 상태</label>
                    <select id="modal-bowel_condition" name="bowel_condition" value={formData.bowel_condition} onChange={handleChange} className={inputClass}>
