...
export function Toast({ message, type, onClose }: ToastProps) {
  ...
  return (
    <div
      role="alert"
      aria-live="assertive"
      className={`fixed top-[84px] left-1/2 z-[200] flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-[var(--shadow-elevated)] text-sm font-bold max-w-[360px] w-max animate-toast-in ${
        type === 'success'
